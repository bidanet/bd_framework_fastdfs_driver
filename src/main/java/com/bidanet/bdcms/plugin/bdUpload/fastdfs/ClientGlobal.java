...
package com.bidanet.bdcms.plugin.bdUpload.fastdfs;

import com.bidanet.bdcms.plugin.bdUpload.common.IniFileReader;
...
*/
	public static void init(String conf_filename) throws FileNotFoundException, IOException, MyException
	{
  		...
  		g_tracker_http_port = iniReader.getIntValue("http.tracker_http_port", 8080);
